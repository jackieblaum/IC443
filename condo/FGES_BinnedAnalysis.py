...
prefix = '5to500gev'
ANALYSISDIR='/work/astropa/users/jrblaum/IC443/fermipy/' + prefix + '/'
...
spectrum = False
spectrumpoints = False
spectrumpointsUL = True
spectrum_mev_or_erg = 'erg' #y-axis
spectrum_mev_or_tev = 'tev' #x-axis
