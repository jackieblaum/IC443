...
if __name__ == "__main__":
    ...
    parser.add_argument('--regname', type=float, help='Name of DS9 region (not including .reg)', required=True)
    parser.add_argument('--binsize', type=str, help='Size of bins', required=False, default='0.025')
    parser.add_argument('--outfile', type=str, help='Name of output file (not including .fits)', required=True)

    args = parser.parse_args()

    ds9reg_cutout(args.infile + '.fits', args.outfile, args.regname + '.reg', args.binsize)